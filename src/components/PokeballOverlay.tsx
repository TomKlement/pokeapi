  ...
  return (
    <>
      ...
      <div onClick={handleOpen}>
        ...
        <div className={`fixed top-0 left-0 w-full h-1/2 bg-red-500 z-50 transition-transform duration-1000 ${opened ? "-translate-y-130" : "translate-y-0"}`}>
        ...
        <div className={`fixed bottom-0 left-0 w-full h-1/2 bg-white z-40 transition-transform duration-1000 ${opened ? "translate-y-130" : "translate-y-0"}`}>
